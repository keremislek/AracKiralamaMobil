...
class VehicleAddFragment : Fragment() {
    ...
    //saveVehicleisvalid olarak yeni method oluşturulacak if blokları içindeki her durum için stringler returnlenecek
